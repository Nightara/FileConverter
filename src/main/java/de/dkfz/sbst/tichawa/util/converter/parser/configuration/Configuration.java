        ...
        new ConfigParser<>(DataType.INSTANT,
            input ->
            {
              ...
              else
              {
                ...
                try
                {
                  euInstant = EU_FORMATTER.parse(input, LocalDate::from)
                ...
                try
                {
                  isoInstant = DateTimeFormatter.ISO_DATE.parse(input, LocalDate::from)
                      .atStartOfDay(ZoneOffset.UTC)
                      .toInstant();
                }
                catch(DateTimeException ex)
                ...
                try
                {
                  timeInstant = TIME_FORMATTER.parse(input, LocalTime::from)
